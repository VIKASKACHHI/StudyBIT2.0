            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground">
                  Share and access previous year questions and notes. Built by
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-8 rounded-xl shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-hover)] transition-shadow">
                ...
                <p className="text-muted-foreground">
                  Share your PYQs and notes anonymously with the community. Help
              ...
              <div className="bg-card p-8 rounded-xl shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-hover)] transition-shadow">
                ...
                <p className="text-muted-foreground">
                  All uploads are reviewed by admins to ensure quality and
                  authenticity.
                </p>
              </div>
              ...
              <div className="bg-card p-8 rounded-xl shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-hover)] transition-shadow">
                ...
                <p className="text-muted-foreground">
                  Download materials whenever you need them. Study smarter, not
                  harder.
                </p>
              </div>
            </div>
