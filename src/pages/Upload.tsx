              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      value={materialType}
                      onValueChange={(value: "pyq" | "notes") => setMaterialType(value)}
                    >
                ...
                <div className="space-y-2">
                  <Label htmlFor="file">
                    File {editId ? "(Optional - leave empty to keep existing file)" : "* (PDF, DOC, DOCX)"}
                  </Label>
                ...
                <Button type="submit" className="w-full" disabled={loading}>
                  {loading ? (editId ? "Updating..." : "Uploading...") : (editId ? "Update Material" : "Upload Material")}
                </Button>
              </form>
            </CardContent>
          </Card>
